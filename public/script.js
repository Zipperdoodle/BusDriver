...
(function (DrivingUI) {
    ...
    function UpcomingStopsTableValues(aCurrentCoordinates, aCurrentTime, aRelevantBusStops) {
        ...
        const lUpcomingStopsTableValues = aRelevantBusStops.map((aBusStop, aIndex) => {
            ...
            return {
                ...
                Name: aIndex == 0 && DrivingUI.cAtBusStop === aBusStop ? `*** ${aBusStop.mBusStop.stop.stop_name}` : `#${aBusStop.mStopNumber}: ${aBusStop.mBusStop.stop.stop_name}<br>ETA: ${lSpeed > 0.01 ? lETAString : "---"}`,
    ...
    function GenerateAugmentedBusStops() {
        ...
        DrivingUI.cRemainingBusStops.forEach((lStop, lIndex) => {
